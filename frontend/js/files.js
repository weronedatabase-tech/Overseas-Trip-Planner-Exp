...
function buildFilesUI() {
    ...
    <div class="flex flex-col h-full w-full relative">
        ...
        <div id="driveLoadingOverlay" class="absolute inset-0 top-[50px] bg-white/60 dark:bg-zinc-950/60 backdrop-blur-sm z-20 hidden-force flex flex-col justify-center items-center">
