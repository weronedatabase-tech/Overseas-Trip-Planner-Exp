...
financePollInterval = setInterval(async () => {
  ...
  try {
      const res = await apiCall('fetchFinance');
      if (res.data) {
          let hasChanges = false;
...
<div class="flex flex-col h-full w-full relative">
  ...
  <div id="financeGlobalSettings" class="bg-white dark:bg-gray-800 p-2 md:p-3 shrink-0 border-b border-gray-200 dark:border-gray-800 flex flex-wrap items-center gap-2 z-10 shadow-[0_4px_10px_-5px_rgba(0,0,0,0.05)]"></div>
