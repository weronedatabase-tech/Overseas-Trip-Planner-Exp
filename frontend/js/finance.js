    ...
    <div class="flex flex-col h-full w-full relative">
      <div class="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 p-2 md:p-3 shrink-0 flex justify-between items-center z-10 shadow-sm rounded-t-xl md:rounded-none">
          ...
          <div class="flex items-center gap-1.5 md:gap-2">
              ...
              <button id="btn-sync-finance" onclick="manualFinanceSync(this)" class="bg-green-50 text-green-700 border-green-200 dark:bg-green-900/30 dark:text-green-300 text-[10px] md:text-xs font-bold px-3 py-1.5 rounded-md hover:bg-green-100 transition flex items-center shadow-sm focus:outline-none shrink-0 border"><span class="btn-text">Saved</span><div class="btn-spinner spinner-white ml-1.5 !w-3 !h-3 hidden-force border-2"></div></button>
          </div>
      </div>
      ...
      <div id="financeLoadingOverlay" class="absolute inset-0 top-[90px] bg-white/60 dark:bg-zinc-950/60 backdrop-blur-sm z-20 flex flex-col justify-center items-center">
