...
<div class="flex flex-col h-full w-full relative bg-white dark:bg-gray-900 rounded-xl shadow-md border-2 border-gray-200 dark:border-gray-800 overflow-hidden">
   <div class="py-1.5 px-2 md:px-3 border-b-2 border-gray-200 dark:border-gray-800 flex justify-between items-center gap-2 shrink-0">
       ...
       <div class="flex items-center gap-2">
           ...
           <button onclick="loadExpiredData()" class="p-1.5 bg-gray-100 dark:bg-gray-800 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition focus:outline-none shadow-md" title="Refresh">
   ...
   <div class="py-1 px-2 md:px-3 bg-gray-50 dark:bg-gray-950 border-b-2 border-gray-200 dark:border-gray-800 shrink-0 flex items-center gap-2">
       <div class="relative w-full flex-1">
           <input type="text" id="expiredSearch" oninput="handleExpiredSearch()" placeholder="Search by name, diet, or medical notes..." class="w-full p-2 pl-9 pr-8 border-2 border-gray-300 dark:border-gray-700 rounded-lg text-sm font-semibold bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-md transition">
   ...
   <div class="flex-1 min-h-0 overflow-auto custom-scrollbar relative" id="expiredTableContainer">
       <table class="w-full table-fixed text-left border-collapse border-b-2 border-gray-200 dark:border-gray-700">
           <thead id="medicalTableHead" class="sticky top-0 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-xs uppercase font-black tracking-wider z-10 shadow-md border-b-2 border-gray-200 dark:border-gray-700">
           </thead>
