    ...
    if (dndState.isDragging && dndState.clone) {
      ...
      document.querySelectorAll(".dnd-dropzone").forEach((dz) => {
        ...
        if (
          ...
          dz.dataset.role !== undefined &&
          dndState.el.dataset.role !== undefined &&
          dz.dataset.role !== dndState.el.dataset.role
        ) {
          isValid = true;
        }
