...
window.setupTokenInput = function(inputId, getSuggestionsCallback) {
    ...
    wrapper.className = "flex flex-wrap items-center gap-1.5 w-full p-2 border-2 border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900 focus-within:ring-1 focus-within:ring-primary cursor-text min-h-[42px]";
    ...
    dropdown.className = "absolute z-50 w-full bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg shadow-xl mt-1 hidden-force max-h-48 overflow-y-auto";
    ...
    function renderDropdown(suggestions) {
        if (!suggestions || suggestions.length === 0) {
            ...
            suggestions.forEach(s => {
                ...
                item.className = "px-3 py-2 text-sm font-bold text-gray-800 dark:text-gray-200 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition border-b-2 border-gray-100 dark:border-gray-700 last:border-0";
