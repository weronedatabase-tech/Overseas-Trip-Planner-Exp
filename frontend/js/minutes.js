...
function buildMinutesUI() {
    ...
    <div class="flex flex-col h-full w-full relative">
        ...
        <div id="minutesLoadingOverlay" class="absolute inset-0 top-[60px] bg-white/60 dark:bg-zinc-950/60 backdrop-blur-sm z-20 flex flex-col justify-center items-center hidden-force">
